...
**Industria:** Agro y Agroindustria  
**Escenario:** Productividad de campo  
**Demo:** Asistente de conocimiento agronomico  
**Solucion Microsoft:** Copilot Studio + Azure AI Foundry (RAG)  
**Valor:** Decisiones mas rapidas con conocimiento centralizado
...
5. Decision sugerida por lote: que hacer, por que y con que fuente.
...
- [Retrieval Augmented Generation en Azure AI Search](https://learn.microsoft.com/azure/search/retrieval-augmented-generation-overview)
- [Generative actions en Copilot Studio](https://learn.microsoft.com/microsoft-copilot-studio/advanced-generative-actions)
